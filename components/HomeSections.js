      ...
      <>
        <section className="flex flex-col">
          <div className="relative flex flex-col h-[calc(100vh-110px)] bg-panel1 bg-top bg-cover w-full">
            {/* /////////////////////// SLIDE 1 TOP ////////////////////////////////////////////////////////////////////////////// */}
            <div
              className={`font-sans flex flex-col h-2/5 w-full items-center`}
            >
          ...
          <div className="relative flex flex-col w-full">
            ...
            <div className={`relative h-[200px] w-full`}>
              <div className="absolute h-[500px] w-full z-[1]">
                <GridPattern color={"deep-blue"} />
              </div>
            ...
            >
              <ContentPanel
                ...
                index={studies.data[0].id}
                primaryButtonLabel={
                  studies.data[0].attributes.primaryButtonLabel
                }
          ...
          <div className="relative flex flex-col w-full">
            ...
            <div className={`relative h-[200px] w-full`}>
              ...
              <div className="absolute h-full w-full">
                <Image
                  src={
                    homeIntro.data.attributes.slide1Cover.data.attributes
                      .formats.large.url
                  }
                  layout="fill"
                  objectFit="cover"
          ...
          <div className="relative flex flex-col w-full">
            ...
            <div className={`relative h-[200px] w-full`}>
              ...
              <div className={`relative h-[200px] w-full`}>
                <Image
                  src={
                    homeIntro.data.attributes.slide2Cover.data.attributes
                      .formats.large.url
                  }
                  layout="fill"
                  objectFit="cover"
          ...
          <div className="relative flex flex-col w-full">
            ...
            <div className={`relative h-[200px] w-full`}>
              ...
              <div className="absolute h-full w-full">
                <Image
                  src={
                    homeIntro.data.attributes.slide3Cover.data.attributes
                      .formats.large.url
                  }
                  layout="fill"
                  objectFit="cover"
          ...
          <div className="relative flex flex-col w-full">
            ...
            <div className={`relative h-[200px] w-full`}>
              ...
              <div className="absolute h-full w-full">
                ...
                <Image
                  src={
                    homeIntro.data.attributes.slide4Cover.data.attributes
                      .formats.large.url
                  }
                  layout="fill"
                  objectFit="cover"
          ...
          <div className="relative flex flex-col w-full">
            ...
            <div className={`relative h-[200px] w-full`}>
              ...
              <div className="absolute h-full w-full">
                ...
                <Image
                  src={
                    homeIntro.data.attributes.slide5Cover.data.attributes
                      .formats.large.url
                  }
                  layout="fill"
                  objectFit="cover"
