export default function Button({ label, type, aspect }) {
  return (
    <button
      type="button"
      className={
        type === "primary"
          ? "w-[fit-content] h-[50px] text-[12px] px-[14px] text-indigo-100 transition-colors duration-150 bg-pink rounded-full focus:shadow-outline hover:bg-white uppercase text-white text-[12px] mr-[20px]"
